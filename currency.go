...
var DefaultRates = map[currency.Code]num.Amount{
	...
	currency.AUD: num.MakeAmount(1577, 3),
	currency.BRL: num.MakeAmount(5379, 3),
	currency.CAD: num.MakeAmount(1439, 3),
	currency.CHF: num.MakeAmount(883, 3),
	currency.CZK: num.MakeAmount(23456, 3),
	currency.DKK: num.MakeAmount(6977, 3),
	currency.HKD: num.MakeAmount(7787, 3),
	currency.INR: num.MakeAmount(85415, 3),
	currency.JPY: num.MakeAmount(149, 0),
	currency.KRW: num.MakeAmount(1384, 0),
	currency.MXN: num.MakeAmount(18467, 3),
	currency.NOK: num.MakeAmount(10812, 3),
	currency.NZD: num.MakeAmount(1722, 3),
	currency.PLN: num.MakeAmount(4015, 3),
	currency.SEK: num.MakeAmount(10512, 3),
	currency.SGD: num.MakeAmount(1344, 3),
	currency.ZAR: num.MakeAmount(18234, 3),
